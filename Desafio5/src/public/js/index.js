...
const deleteProd = (id) =>{
    socketClient.emit('deleteProductById', id);
}
...
form.addEventListener('submit',(e)=>{
    ...
    const status = true
    socketClient.emit('newProduct', { title, description, code, price, stock, category, thumbnails ,status});
});
                ...
                <div class="container-fluid mb-2 d-flex flex-column align-items-center">
                    <div class="card text-center" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <img class="card-img-bottom" src=${p.thumbnails} alt="Card image cap">
                        </div>
                    </div>
